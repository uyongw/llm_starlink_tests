...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = **********a9                                                   
    + (unsigned long long)*(*******a9 + 2)
    + (unsigned long long)*(********a9 + 5)
    + (unsigned long long)*(***a9 + 4)
    + (unsigned long long)*(*********a9 + 7)
    + (unsigned long long)*(****a9 + 8)
    + (unsigned long long)*(*****a9 + 8)
    + (unsigned long long)*(**a9 + 6)
    + (unsigned long long)*(******a9 + 2)
    ;
