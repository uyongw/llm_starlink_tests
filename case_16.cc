...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = ****************a15                                                   
    + (unsigned long long)*(*******a15 + 4)
    + (unsigned long long)*(**********a15 + 11)
    + (unsigned long long)*(********a15 + 2)
    + (unsigned long long)*(**************a15 + 12)
    + (unsigned long long)*(***a15 + 12)
    + (unsigned long long)*(************a15 + 9)
    + (unsigned long long)*(***************a15 + 1)
    + (unsigned long long)*(***********a15 + 9)
    + (unsigned long long)*(*************a15 + 3)
    + (unsigned long long)*(*********a15 + 11)
    + (unsigned long long)*(****a15 + 14)
    + (unsigned long long)*(*****a15 + 10)
    + (unsigned long long)*(**a15 + 7)
    + (unsigned long long)*(******a15 + 8)
    ;
