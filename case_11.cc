...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = ***********a10                                                   
    + (unsigned long long)*(*******a10 + 3)
    + (unsigned long long)*(**********a10 + 2)
    + (unsigned long long)*(********a10 + 7)
    + (unsigned long long)*(***a10 + 9)
    + (unsigned long long)*(*********a10 + 6)
    + (unsigned long long)*(****a10 + 6)
    + (unsigned long long)*(*****a10 + 4)
    + (unsigned long long)*(**a10 + 4)
