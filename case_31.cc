...
int compute_starlink() {
  unsigned long long *********************a20 = (unsigned long long *********************)&mat[20][0];
  unsigned long long ****************************a27 = (unsigned long long ****************************)&mat[27][0];
  unsigned long long ***************************a26 = (unsigned long long ***************************)&mat[26][0];
  unsigned long long ***********************a22 = (unsigned long long ***********************)&mat[22][0];
  unsigned long long *******************a18 = (unsigned long long *******************)&mat[18][0];
  unsigned long long *************************a24 = (unsigned long long *************************)&mat[24][0];
  unsigned long long ******a5 = (unsigned long long ******)&mat[5][0];
  unsigned long long ******************************a29 = (unsigned long long ******************************)&mat[29][0];
  unsigned long long **********************a21 = (unsigned long long **********************)&mat[21][0];
  ...
  unsigned long long **************************a25 = (unsigned long long **************************)&mat[25][0];
  unsigned long long ***********a10 = (unsigned long long ***********)&mat[10][0];
  unsigned long long *******************************a30 = (unsigned long long *******************************)&mat[30][0];
  ...
  unsigned long long ************************a23 = (unsigned long long ************************)&mat[23][0];
  ...
  unsigned long long *****************************a28 = (unsigned long long *****************************)&mat[28][0];
  *a21 = a20;
  *a28 = a27;
  *a27 = a26;
  *a23 = a22;
  ...
  *a0 = a;
  ...
  unsigned long long res = *******************************a30                                                   
    + (unsigned long long)*(**********************a30 + 29)
    + (unsigned long long)*(*****************************a30 + 10)
    + (unsigned long long)*(****************************a30 + 26)
    + (unsigned long long)*(************************a30 + 17)
    + (unsigned long long)*(********************a30 + 15)
    + (unsigned long long)*(**************************a30 + 22)
    + (unsigned long long)*(*******a30 + 25)
    + (unsigned long long)*(***********************a30 + 24)
    + (unsigned long long)*(**********a30 + 18)
    + (unsigned long long)*(********a30 + 27)
    + (unsigned long long)*(**************a30 + 11)
    + (unsigned long long)*(***a30 + 18)
    + (unsigned long long)*(***************************a30 + 12)
    + (unsigned long long)*(************a30 + 10)
    + (unsigned long long)*(***************a30 + 10)
    + (unsigned long long)*(***********a30 + 25)
    + (unsigned long long)*(*********************a30 + 24)
    + (unsigned long long)*(*************a30 + 19)
    + (unsigned long long)*(******************a30 + 2)
    + (unsigned long long)*(*******************a30 + 13)
    + (unsigned long long)*(*********a30 + 2)
    + (unsigned long long)*(****a30 + 6)
    + (unsigned long long)*(*****a30 + 29)
    + (unsigned long long)*(*************************a30 + 11)
    + (unsigned long long)*(**a30 + 16)
    + (unsigned long long)*(******a30 + 5)
    + (unsigned long long)*(*****************a30 + 9)
    + (unsigned long long)*(****************a30 + 24)
    + (unsigned long long)*(******************************a30 + 20)
    ;
