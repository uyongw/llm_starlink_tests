...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = *******************a18                                                   
    + (unsigned long long)*(*******a18 + 5)
    + (unsigned long long)*(**********a18 + 2)
    + (unsigned long long)*(********a18 + 12)
    + (unsigned long long)*(**************a18 + 17)
    + (unsigned long long)*(***a18 + 4)
    + (unsigned long long)*(************a18 + 15)
    + (unsigned long long)*(***************a18 + 15)
    + (unsigned long long)*(***********a18 + 2)
