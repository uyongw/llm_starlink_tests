...
int compute_starlink() {
  ...
  unsigned long long ********************************a31 = (unsigned long long ********************************)&mat[31][0];
  ...
  *a0 = a;
  ...
  unsigned long long res = ********************************a31                                                   
    + (unsigned long long)*(**********************a31 + 6)
    + (unsigned long long)*(*****************************a31 + 13)
    + (unsigned long long)*(****************************a31 + 2)
    + (unsigned long long)*(************************a31 + 22)
    + (unsigned long long)*(********************a31 + 14)
    + (unsigned long long)*(**************************a31 + 5)
    + (unsigned long long)*(*******a31 + 16)
    + (unsigned long long)*(*******************************a31 + 17)
    + (unsigned long long)*(***********************a31 + 28)
    + (unsigned long long)*(**********a31 + 17)
    + (unsigned long long)*(********a31 + 17)
    + (unsigned long long)*(**************a31 + 3)
    + (unsigned long long)*(***a31 + 15)
    + (unsigned long long)*(***************************a31 + 12)
    + (unsigned long long)*(************a31 + 18)
    + (unsigned long long)*(***************a31 + 16)
    + (unsigned long long)*(***********a31 + 18)
    + (unsigned long long)*(*********************a31 + 28)
    + (unsigned long long)*(*************a31 + 13)
    + (unsigned long long)*(******************a31 + 5)
    + (unsigned long long)*(*******************a31 + 4)
    + (unsigned long long)*(*********a31 + 25)
    + (unsigned long long)*(****a31 + 28)
    + (unsigned long long)*(*****a31 + 10)
    + (unsigned long long)*(*************************a31 + 28)
    + (unsigned long long)*(**a31 + 15)
    + (unsigned long long)*(******a31 + 13)
    + (unsigned long long)*(*****************a31 + 9)
    + (unsigned long long)*(****************a31 + 30)
    + (unsigned long long)*(******************************a31 + 28)
    ;
