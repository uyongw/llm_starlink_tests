...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = ***************************a26                                                   
    + (unsigned long long)*(**********************a26 + 13)
    + (unsigned long long)*(************************a26 + 19)
    + (unsigned long long)*(********************a26 + 2)
    + (unsigned long long)*(**************************a26 + 1)
    + (unsigned long long)*(*******a26 + 7)
    + (unsigned long long)*(***********************a26 + 25)
    + (unsigned long long)*(**********a26 + 8)
    + (unsigned long long)*(********a26 + 13)
    + (unsigned long long)*(**************a26 + 24)
    + (unsigned long long)*(***a26 + 2)
    + (unsigned long long)*(************a26 + 1)
    + (unsigned long long)*(***************a26 + 15)
    + (unsigned long long)*(***********a26 + 17)
    + (unsigned long long)*(*********************a26 + 21)
    + (unsigned long long)*(*************a26 + 6)
    + (unsigned long long)*(******************a26 + 11)
    + (unsigned long long)*(*******************a26 + 5)
    + (unsigned long long)*(*********a26 + 6)
    + (unsigned long long)*(****a26 + 23)
    + (unsigned long long)*(*****a26 + 25)
    + (unsigned long long)*(*************************a26 + 17)
    + (unsigned long long)*(**a26 + 7)
    + (unsigned long long)*(******a26 + 20)
    + (unsigned long long)*(*****************a26 + 2)
    + (unsigned long long)*(****************a26 + 11)
    ;
