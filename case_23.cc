...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = ***********************a22                                                   
    + (unsigned long long)*(**********************a22 + 16)
    + (unsigned long long)*(********************a22 + 11)
    + (unsigned long long)*(*******a22 + 1)
    + (unsigned long long)*(**********a22 + 7)
    + (unsigned long long)*(********a22 + 16)
    + (unsigned long long)*(**************a22 + 14)
    + (unsigned long long)*(***a22 + 18)
    + (unsigned long long)*(************a22 + 18)
    + (unsigned long long)*(***************a22 + 12)
    + (unsigned long long)*(***********a22 + 13)
    + (unsigned long long)*(*********************a22 + 10)
    + (unsigned long long)*(*************a22 + 2)
    + (unsigned long long)*(******************a22 + 15)
    + (unsigned long long)*(*******************a22 + 7)
    + (unsigned long long)*(*********a22 + 18)
    + (unsigned long long)*(****a22 + 10)
    + (unsigned long long)*(*****a22 + 14)
