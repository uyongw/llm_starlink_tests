...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = **********************a21                                                   
    + (unsigned long long)*(********************a21 + 14)
    + (unsigned long long)*(*******a21 + 13)
    + (unsigned long long)*(**********a21 + 7)
    + (unsigned long long)*(********a21 + 1)
    + (unsigned long long)*(**************a21 + 12)
    + (unsigned long long)*(***a21 + 5)
    + (unsigned long long)*(************a21 + 2)
    + (unsigned long long)*(***************a21 + 18)
    + (unsigned long long)*(***********a21 + 6)
    + (unsigned long long)*(*********************a21 + 20)
    + (unsigned long long)*(*************a21 + 10)
    + (unsigned long long)*(******************a21 + 7)
    + (unsigned long long)*(*******************a21 + 17)
    + (unsigned long long)*(*********a21 + 5)
    + (unsigned long long)*(****a21 + 10)
    + (unsigned long long)*(*****a21 + 17)
    + (unsigned long long)*(**a21 + 13)
    + (unsigned long long)*(******a21 + 3)
    + (unsigned long long)*(*****************a21 + 1)
    + (unsigned long long)*(****************a21 + 3)
    ;
