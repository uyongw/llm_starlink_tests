...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = ************************a23                                                   
    + (unsigned long long)*(**********************a23 + 10)
    + (unsigned long long)*(********************a23 + 8)
    + (unsigned long long)*(*******a23 + 2)
    + (unsigned long long)*(***********************a23 + 17)
    + (unsigned long long)*(**********a23 + 18)
    + (unsigned long long)*(********a23 + 20)
    + (unsigned long long)*(**************a23 + 4)
    + (unsigned long long)*(***a23 + 20)
    + (unsigned long long)*(************a23 + 10)
    + (unsigned long long)*(***************a23 + 5)
    + (unsigned long long)*(***********a23 + 21)
    + (unsigned long long)*(*********************a23 + 16)
    + (unsigned long long)*(*************a23 + 1)
    + (unsigned long long)*(******************a23 + 7)
    + (unsigned long long)*(*******************a23 + 22)
    + (unsigned long long)*(*********a23 + 19)
    + (unsigned long long)*(****a23 + 20)
    + (unsigned long long)*(*****a23 + 5)
    + (unsigned long long)*(**a23 + 1)
    + (unsigned long long)*(******a23 + 6)
    + (unsigned long long)*(*****************a23 + 15)
    + (unsigned long long)*(****************a23 + 18)
    ;
