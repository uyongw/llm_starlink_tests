...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = *****************************a28                                                   
    + (unsigned long long)*(**********************a28 + 25)
    + (unsigned long long)*(****************************a28 + 5)
    + (unsigned long long)*(************************a28 + 22)
    + (unsigned long long)*(********************a28 + 14)
    + (unsigned long long)*(**************************a28 + 15)
    + (unsigned long long)*(*******a28 + 20)
    + (unsigned long long)*(***********************a28 + 22)
    + (unsigned long long)*(**********a28 + 23)
    + (unsigned long long)*(********a28 + 6)
    + (unsigned long long)*(**************a28 + 27)
    + (unsigned long long)*(***a28 + 12)
    + (unsigned long long)*(***************************a28 + 6)
    + (unsigned long long)*(************a28 + 21)
    + (unsigned long long)*(***************a28 + 11)
    + (unsigned long long)*(***********a28 + 20)
    + (unsigned long long)*(*********************a28 + 24)
    + (unsigned long long)*(*************a28 + 10)
    + (unsigned long long)*(******************a28 + 10)
    + (unsigned long long)*(*******************a28 + 27)
    + (unsigned long long)*(*********a28 + 23)
    + (unsigned long long)*(****a28 + 12)
    + (unsigned long long)*(*****a28 + 27)
    + (unsigned long long)*(*************************a28 + 16)
    + (unsigned long long)*(**a28 + 7)
    + (unsigned long long)*(******a28 + 21)
    + (unsigned long long)*(*****************a28 + 14)
    + (unsigned long long)*(****************a28 + 18)
    ;
