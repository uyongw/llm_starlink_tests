...
int compute_starlink() {
  unsigned long long *******************a18 = (unsigned long long *******************)&mat[18][0];
  ...
  unsigned long long ********************a19 = (unsigned long long ********************)&mat[19][0];
  unsigned long long ************a11 = (unsigned long long ************)&mat[11][0];
  unsigned long long *****************a16 = (unsigned long long *****************)&mat[16][0];
  unsigned long long ******************a17 = (unsigned long long ******************)&mat[17][0];
  ...
  unsigned long long ****************a15 = (unsigned long long ****************)&mat[15][0];
  ...
  *a0 = a;
  ...
  unsigned long long res = ********************a19                                                   
    + (unsigned long long)*(*******a19 + 18)
    + (unsigned long long)*(**********a19 + 16)
    + (unsigned long long)*(********a19 + 5)
    + (unsigned long long)*(**************a19 + 18)
    + (unsigned long long)*(***a19 + 13)
    + (unsigned long long)*(************a19 + 18)
    + (unsigned long long)*(***************a19 + 12)
    + (unsigned long long)*(***********a19 + 1)
    + (unsigned long long)*(*************a19 + 18)
    + (unsigned long long)*(******************a19 + 17)
    + (unsigned long long)*(*******************a19 + 5)
    + (unsigned long long)*(*********a19 + 17)
    + (unsigned long long)*(****a19 + 11)
    + (unsigned long long)*(*****a19 + 16)
    + (unsigned long long)*(**a19 + 18)
    + (unsigned long long)*(******a19 + 6)
    + (unsigned long long)*(*****************a19 + 14)
    + (unsigned long long)*(****************a19 + 7)
    ;
