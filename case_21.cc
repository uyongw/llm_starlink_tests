...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = *********************a20                                                   
    + (unsigned long long)*(********************a20 + 6)
    + (unsigned long long)*(*******a20 + 13)
    + (unsigned long long)*(**********a20 + 1)
    + (unsigned long long)*(********a20 + 7)
    + (unsigned long long)*(**************a20 + 17)
    + (unsigned long long)*(***a20 + 11)
    + (unsigned long long)*(************a20 + 1)
    + (unsigned long long)*(***************a20 + 4)
    + (unsigned long long)*(***********a20 + 8)
    + (unsigned long long)*(*************a20 + 3)
    + (unsigned long long)*(******************a20 + 3)
    + (unsigned long long)*(*******************a20 + 7)
    + (unsigned long long)*(*********a20 + 6)
    + (unsigned long long)*(****a20 + 12)
    + (unsigned long long)*(*****a20 + 5)
    + (unsigned long long)*(**a20 + 6)
    + (unsigned long long)*(******a20 + 6)
    + (unsigned long long)*(*****************a20 + 7)
    + (unsigned long long)*(****************a20 + 3)
