...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = ******************a17                                                   
    + (unsigned long long)*(*******a17 + 14)
    + (unsigned long long)*(**********a17 + 8)
    + (unsigned long long)*(********a17 + 9)
    + (unsigned long long)*(**************a17 + 15)
    + (unsigned long long)*(***a17 + 12)
    + (unsigned long long)*(************a17 + 9)
    + (unsigned long long)*(***************a17 + 9)
    + (unsigned long long)*(***********a17 + 12)
    + (unsigned long long)*(*************a17 + 5)
    + (unsigned long long)*(*********a17 + 5)
    + (unsigned long long)*(****a17 + 8)
    + (unsigned long long)*(*****a17 + 5)
    + (unsigned long long)*(**a17 + 4)
    + (unsigned long long)*(******a17 + 15)
    + (unsigned long long)*(*****************a17 + 8)
