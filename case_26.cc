...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = **************************a25                                                   
    + (unsigned long long)*(**********************a25 + 14)
    + (unsigned long long)*(************************a25 + 10)
    + (unsigned long long)*(********************a25 + 6)
    + (unsigned long long)*(*******a25 + 5)
    + (unsigned long long)*(***********************a25 + 3)
    + (unsigned long long)*(**********a25 + 16)
    + (unsigned long long)*(********a25 + 1)
    + (unsigned long long)*(**************a25 + 16)
    + (unsigned long long)*(***a25 + 16)
    + (unsigned long long)*(************a25 + 10)
    + (unsigned long long)*(***************a25 + 23)
    + (unsigned long long)*(***********a25 + 6)
    + (unsigned long long)*(*********************a25 + 22)
    + (unsigned long long)*(*************a25 + 19)
    + (unsigned long long)*(******************a25 + 14)
    + (unsigned long long)*(*******************a25 + 4)
    + (unsigned long long)*(*********a25 + 4)
    + (unsigned long long)*(****a25 + 22)
    + (unsigned long long)*(*****a25 + 7)
    + (unsigned long long)*(*************************a25 + 9)
    + (unsigned long long)*(**a25 + 22)
    + (unsigned long long)*(******a25 + 10)
    + (unsigned long long)*(*****************a25 + 4)
    + (unsigned long long)*(****************a25 + 24)
    ;
