...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = *****************a16                                                   
    + (unsigned long long)*(*******a16 + 14)
    + (unsigned long long)*(**********a16 + 12)
    + (unsigned long long)*(********a16 + 3)
    + (unsigned long long)*(**************a16 + 6)
    + (unsigned long long)*(***a16 + 14)
    + (unsigned long long)*(************a16 + 12)
    + (unsigned long long)*(***************a16 + 6)
    + (unsigned long long)*(***********a16 + 9)
    + (unsigned long long)*(*************a16 + 3)
    + (unsigned long long)*(*********a16 + 11)
    + (unsigned long long)*(****a16 + 15)
    + (unsigned long long)*(*****a16 + 1)
    + (unsigned long long)*(**a16 + 8)
    + (unsigned long long)*(******a16 + 12)
    + (unsigned long long)*(****************a16 + 2)
    ;
