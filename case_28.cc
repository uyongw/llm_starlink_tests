...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = ****************************a27                                                   
    + (unsigned long long)*(**********************a27 + 13)
    + (unsigned long long)*(************************a27 + 1)
    + (unsigned long long)*(********************a27 + 26)
    + (unsigned long long)*(**************************a27 + 9)
    + (unsigned long long)*(*******a27 + 6)
    + (unsigned long long)*(***********************a27 + 13)
    + (unsigned long long)*(**********a27 + 2)
    + (unsigned long long)*(********a27 + 1)
    + (unsigned long long)*(**************a27 + 4)
    + (unsigned long long)*(***a27 + 13)
    + (unsigned long long)*(***************************a27 + 6)
    + (unsigned long long)*(************a27 + 5)
    + (unsigned long long)*(***************a27 + 8)
    + (unsigned long long)*(***********a27 + 24)
    + (unsigned long long)*(*********************a27 + 13)
    + (unsigned long long)*(*************a27 + 20)
    + (unsigned long long)*(******************a27 + 15)
    + (unsigned long long)*(*******************a27 + 21)
    + (unsigned long long)*(*********a27 + 15)
    + (unsigned long long)*(****a27 + 4)
    + (unsigned long long)*(*****a27 + 6)
    + (unsigned long long)*(*************************a27 + 16)
    + (unsigned long long)*(**a27 + 13)
    + (unsigned long long)*(******a27 + 22)
    + (unsigned long long)*(*****************a27 + 24)
    + (unsigned long long)*(****************a27 + 18)
    ;
