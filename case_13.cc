...
int compute_starlink() {
  ...
  *a0 = a;
  ...
  unsigned long long res = *************a12                                                   
    + (unsigned long long)*(*******a12 + 10)
    + (unsigned long long)*(**********a12 + 4)
    + (unsigned long long)*(********a12 + 5)
    + (unsigned long long)*(***a12 + 11)
    + (unsigned long long)*(************a12 + 4)
    + (unsigned long long)*(***********a12 + 5)
    + (unsigned long long)*(*********a12 + 2)
    + (unsigned long long)*(****a12 + 10)
    + (unsigned long long)*(*****a12 + 3)
    + (unsigned long long)*(**a12 + 6)
